...
class WorkWechat {
    ...
    requestWithAccessToken(options, reTry) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let { data } = yield (0, axios_1.default)(Object.assign(Object.assign({}, options), { params }));
            // 已经是重试了，直接返回结果
            if (reTry)
                return data;
            ...
            if ([
                ...
                data = this.requestWithAccessToken(Object.assign(Object.assign({}, options), { params }), true);
            }
            if (data.errcode !== 0)
                throw Error(`${data.errcode} ${data.errmsg}`);
            return data;
        });
    }
    /**
    ...
    getAccessToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data } = yield (0, axios_1.default)({ url, params });
            this.accessToken = new AccessToken_1.default(data.access_token, data.expires_in);
